...
extension Date {
    /// Normalizes any date to 00:00:00 (start of day) in the current timezone
    func normalizedToStartOfDay() -> Date {
        return Calendar.current.startOfDay(for: self)
    }
    
    /// Normalizes date to start of day in a specific timezone
    func normalizedToStartOfDay(in timeZone: TimeZone) -> Date {
